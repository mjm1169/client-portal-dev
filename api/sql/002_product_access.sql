...
--   product     site section: 'radial', 'scrollytelling', 'industry-analytics', ...
...
--   industry-analytics   -> container "industry-analytics",   blob {client}/{blob_name}
--     (container names can't contain underscores in Azure — product ids for report
--      products use hyphens to match their container name 1:1; see
--      _container_for_product() in api/reports/__init__.py)
...
INSERT INTO ProductAccess (email, product, client, blob_name, granted_by) VALUES
    ...
    ('<user_email>', 'industry-analytics', '<client_folder>', '<report_file>', '<granted_by_email>');
